...
This repository implements an automated data acquisition and visualisation workflow for hourly FAANG stock price data using Python and GitHub Actions. Expected outputs are CSV and PNG files.   
